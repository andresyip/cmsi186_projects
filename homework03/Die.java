...
public class Die {
   ...
   */
   public Die( int nSides ) {
      ...
      if ( nSides < MINIMUM_SIDES ) {
        throw new IllegalArgumentException("Number of sides must be least 4.");
      }
   ...
   */
   public static void main( String[] args ) {
      int i = 0;
      while( i < 10 ) {
        Die die = new Die ( (int) Math.ceil(Math.random() * 6 + 3) );
        System.out.println( "sides " + die.sides + ". pips: " + die.pips + ". roll: " + die.roll() + 
                            ". value: " + die.getValue() + ". string: " + die.toString() + "." );
        i++;
      }
   }
}